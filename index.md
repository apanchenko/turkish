<!-- markdownlint-disable MD022 MD032 MD033 MD036 MD041 -->
# Türkçe
...
- [Формы глаголов](#формы-глаголов)
  ...
  - [Ip](#ıp)
  - [Действие не сделав что-то - madan](#madan-meden)
  - [Должен - malı](#malı)
- [Bağlaçlar](#bağlaçlar)
## Алфавит
...
**🥕 + (y: не глагол на гласную) + dı di du dü + личный аффикс**
| кто   | личный афикс     |
|-------|------------------|
| ben   | ım im um üm      |
| sen   | ın in un ün      |
...
### arak erek
**🥕 + arak erek** Выполнять действие делая что-то.
...
### Dönüşlü fiiller - возвратные глаголы
...
| sarmak     | обвивать     | sarınmak    | обвиваться     | şalına sarınmak | обвиться шалью |
...
- если из существительного **🥕 + laş leş + mak**
...
- пассивно желаемое **🥕 + sa se + л.аф прошедшего времени**
  - keşke - вот бы
...
- **🥕 + ar ar ır ir ur ür ıyor iyor uyur üyür + ken** когда мы что-то делаем, с глаголами. Два действия происходят одновременно
  - когда одно то другое
    - Ben çalış**ırken** - когда я работаю
...
### 🥕 + alı eli - С тех пор как
1. **🥕 + alı eli** Пока не делали...
    - Biz görüşme**yeli** sen çok değiştin. - С тех пор как мы не виделись, ты очень изменился.
    - Ben size gelme**yeli** burada çok yeni ev inşa etmişler. - С тех пор как я не приезжал к вам, здесь построили много новых домов.
    - Anton spor yapma**yalı** kilo aldı. - С тех пор как Антон не занимается спортом, он набрал вес.
    - Lena Ekin'i aramayalı çok yıl geçti. - С тех пор как Лена не звонила Экину, прошло много лет.
2. **🥕 + alı eli** С глаголами. С тех пор как... С положительным оттенком.
    - Beb İstanbula gel**eli** normal yaşıyorum. - С тех пор как я приехал в Стамбул, я живу нормально.
...
3. **🥕 пр.время 🥕 + alı eli**  С тех пор как... С отрицательным оттенком.
...
4. **🥕 + dık dik duk dük + афикс принадлежности + dan beri** С тех пор как... Не важно хорошо или плохо.
...
- **🥕 + dan den + beri** С сущестительными.
  1. С какого то времени.
  2. Уже сколько-то времени, если есть числительные.
  - Ben mart ayın**dan**/mart**tan** **beri** Türkiyede yşıyorum - Я живу в Турции с марта
...
- **🥕 + dır dir dur dür** Уже сколько-то времени.
  ...
  - Ne zamandır? - Уже сколько времени?
  - epeydir - достаточно долго
## Sözlük
