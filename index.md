...
- Когда сделал **`глагол + dık + аффикс принадлежности + zaman`** или **`глагол + dık + аффикс принадлежности + da de`**
  - прошедшее время
    - Ben dersten çık**tığım** zaman когда я вышла с урока, побежала на остановку
    - Ben dersten çıktı**ğımda** durağa koştum
  - Будущее время
  ...
  - Если есть слово *ılk* или *son* лучше использовать вариант без *zaman*
    - Ben onu ilk gördüğümde çok şaşırdım - Я очень удивился когда увидел в первый раз.
    - Ben son görüştüğümüzde yağmur yağıyordu - Когда мы в последний раз встречались, шёл дождь
- После того как...
  ...
  - Ben evden çıktığım zaman anahtarları kontrol ediyorum - После того как я выхожу из дома, проверяю ключи
  - Eve döndüğüm zaman önce telefon mesajlarına bakarım
- Перед тем как... **`🥕+ acak ecek + аффикс принадлежности + zaman`**
  - Ben evden çıkacağım zaman annemle vedalaştım - Перед тем как выйти из дома, я попрощался с мамой
  - Ben evden çıkacağım zaman annemle vedalaşıyorum - Перед тем как выйти из дома, я прощаюсь с мамой
  - Ben evden çıkacağım zaman annemle vedalaşacağım - Перед тем как выйти из дома, я попрощаюсь с мамой
  - Ben evden çıkacağım zaman anahtaları kontrol ediyorum - Перед тем как выйти из дома, проверяю ключи
## Bağlaçlar
- **ve** - и
