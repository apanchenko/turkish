...
- [Формы глаголов](#формы-глаголов)
  ...
  - [Понудительный залог](#ettirgen-çatı)
- [Союзы](#bağlaçlar)
- [Словарь](#sözlük)
- [Музыка](#müzik)
## Alfabe
...
- **`ar er`**
  - çık**ar**mak
    - Müdür beni çık**ar**dı - Директор выгнал меня. Используем **`bana`** с переходными глаголами (кого? что?). Используем **`beni`** с непереходными глаголами.
  - kop**ar**mak - срывать
  - gid**er**mek
- **`ıt it ut üt`**
  - ak**ıt**mak - пролить
