...
- **Образование союзов:**
  - Çalışıyor ki başarılı olacak. (Он работает, чтобы быть успешным.) В этом случае "ki" используется как союз, связывающий два предложения и выражающий причину или цель.
...
|-------|------------------------------------------|
| sen   | **корень**                               |
| o     | **корень + sın sin sun sün**             |
| siz   | **корень + ın in un ün**                 |
| onlar | **корень + sınlar sinlar sunlar sünler** |
...
- Meğerse bir saat önce Katya gitmiş
...
- Вопрос. Вопросы на **sen** и **siz** воспринимаются как просьба или предложение. На русский переводится через отрицание.
